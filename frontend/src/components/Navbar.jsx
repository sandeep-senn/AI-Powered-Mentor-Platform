    ...
    >
      ...
      {menuOpen && (
        <div className="md:hidden mt-3 bg-gray-100 rounded-xl shadow px-6 py-4 space-y-3">
          ...
          <hr />
          <button className="w-full bg-indigo-600 text-white rounded-full py-2 font-semibold">
            Login
          </button>
          <button className="w-full bg-green-500 text-white rounded-full py-2 font-semibold">
            Sign Up
          </button>
        </div>
      )}
